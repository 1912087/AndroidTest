    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(search_location.getText().length() == 0){
                ...
                }else if(search_location.getText().length() < 3){
                    Toast.makeText(MapActivity.this, "3글자 이상 입력해주세요", Toast.LENGTH_SHORT).show();
                    search_location.requestFocus();
                }else{
                    ...
                    if(mapDto.getCount() != 0){
                        ...
                        tvCountry.setText(mapDto.getTourist() + ", " + mapDto.getCountry());
